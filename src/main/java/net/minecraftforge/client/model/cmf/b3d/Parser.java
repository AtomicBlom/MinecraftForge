package net.minecraftforge.client.model.cmf.b3d;
...
public class Parser
{
    ...
    private Model bb3d() throws IOException
    {
        ...
        if(version / 100 > Parser.version / 100)
            throw new IOException("Unsupported major cmf version: " + ((float)version / 100));
        if(version % 100 > Parser.version % 100)
            logger.warn(String.format("Minor version differnce in cmf: ", ((float)version / 100)));
