...
import net.minecraftforge.client.model.cmf.common.Brush;
import net.minecraftforge.client.model.cmf.common.Face;
...
import net.minecraftforge.client.model.cmf.opengex.ogex.MeshType;
