...
import net.minecraftforge.client.model.cmf.common.IAnimation;
import net.minecraftforge.client.model.cmf.common.Key;
import net.minecraftforge.client.model.cmf.common.Node;
